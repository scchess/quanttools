...
back_test <- function(enter, exit, price, stop_loss = -1000, side = 1L) {
    .Call(QuantTools_back_test, enter, exit, price, stop_loss, side)
}
...
#' @export
ema <- function(x, n) {
    .Call(QuantTools_ema, x, n)
}

na_locf_numeric <- function(x) {
    .Call(QuantTools_na_locf_numeric, x)
}
...
roll_lm <- function(x, y, n) {
    .Call(QuantTools_roll_lm, x, y, n)
}

#' @rdname roll_lm
#' @export
roll_correlation <- function(x, y, n) {
    .Call(QuantTools_roll_correlation, x, y, n)
}
...
roll_percent_rank <- function(x, n) {
    .Call(QuantTools_roll_percent_rank, x, n)
}
...
roll_range <- function(x, n) {
    .Call(QuantTools_roll_range, x, n)
}

#' @rdname roll_range
#' @export
roll_quantile <- function(x, n, p) {
    .Call(QuantTools_roll_quantile, x, n, p)
}

#' @rdname roll_range
#' @export
roll_min <- function(x, n) {
    .Call(QuantTools_roll_min, x, n)
}

#' @rdname roll_range
#' @export
roll_max <- function(x, n) {
    .Call(QuantTools_roll_max, x, n)
}
...
roll_sd_filter <- function(x, n, k = 1, m = 10L) {
    .Call(QuantTools_roll_sd_filter, x, n, k, m)
}
...
roll_volume_profile <- function(ticks, timeFrame, step, alpha, cut) {
    .Call(QuantTools_roll_volume_profile, ticks, timeFrame, step, alpha, cut)
}
...
#' @export
rsi <- function(x, n) {
    .Call(QuantTools_rsi, x, n)
}

run_tests <- function() {
    .Call(QuantTools_run_tests)
}
...
stochastic <- function(x, n, nFast, nSlow) {
    .Call(QuantTools_stochastic, x, n, nFast, nSlow)
}
...
to_candles <- function(ticks, timeframe) {
    .Call(QuantTools_to_candles, ticks, timeframe)
}
